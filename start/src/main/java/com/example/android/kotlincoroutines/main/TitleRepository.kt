...
class TitleRepository(val network: MainNetwork, val titleDao: TitleDao) {
    ...
    {
        //TODO: Refresh from network and write to DB
       //Interact with *blocking* network and IO calls from coroutine
        withContext(Dispatchers.IO)
        {
            ...
            {
                //If it's not succesful , inform the callback of the error
